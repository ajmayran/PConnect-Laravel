...
class VerifyRetailerEmail extends BaseVerifyEmail
{
    /**
     * The user entity.
     *
    ...
    protected function buildMailMessage($url)
    {
        $mailMessage = (new MailMessage)
            ->subject('Verify Your Retailer Account Email Address')
            ->view('mails.retailer-verify-email', [
        ...
        $mailMessage->withSymfonyMessage(function ($message) {
            ...
            // These are safe to add as they're string literals
