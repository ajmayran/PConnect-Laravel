{{-- filepath: c:\Users\nunez\Documents\PConnect-Laravel\resources\views\admin\tickets\rejected.blade.php --}}
<x-app-layout>
    <div class="flex">
            ...
            <div class="container px-4 py-8 mx-auto">
                <div class="overflow-hidden bg-white rounded-lg shadow-lg">
                    <div class="px-6 py-4 bg-gray-800">
                        <h1 class="text-2xl font-bold text-white">Rejected Tickets</h1>
                    </div>
                    <div class="p-6">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    @foreach($tickets as $ticket)
                                        <tr class="hover:bg-gray-50">
                                            ...
                                            <td class="px-6 py-4 text-sm text-gray-900 whitespace-nowrap">
                                                @if ($ticket->user->retailerProfile)
                                                    {{ $ticket->user->retailerProfile->business_name }}
                                                @elseif ($ticket->user->distributor)
                                                    {{ $ticket->user->distributor->company_name }}
                                                @else
                                                    N/A
                                                @endif
                                            </td>
