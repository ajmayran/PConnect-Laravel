<x-guest-layout>
    <div class="flex items-center justify-center min-h-screen px-4 py-12 bg-gradient-to-r from-green-400 to-green-600 sm:px-6 lg:px-8">
        ...
        <div class="p-5 flex flex-row w-full h-full  bg-white shadow-2xl rounded-3xl" style="height: 90%; width: 80%;">
            <div class="w-1/2 p-4 border rounded-2xl" style="background-image: url('{{ asset('img/signup4.png') }}'); background-position: center;">
            ...
            <div class="w-1/2 p-20  rounded-2xl ">
                ...
                <div class="text-center">
                    <h2 class="text-2xl font-bold text-gray-900">Register as Retailer</h2>
                    <p class="mt-2 text-xl text-gray-600">Create your account to get started</p>
                </div>

                <form method="POST" action="{{ route('register.retailer') }}" enctype="multipart/form-data" class="mt-8 space-y-6">
                    @csrf
