<!-- filepath: c:\Users\EMMAN\Documents\PConnect-Laravel\resources\views\components\admin-sidebar.blade.php -->
<div id="admin-sidebar"
    ...
    style="background-color: #abebc6; display: flex; flex-direction: column; justify-content: space-between;">
    <!-- Sidebar Content -->
    <div>
