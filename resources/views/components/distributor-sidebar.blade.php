<div id="sidebar" class="fixed top-0 bottom-0 p-2 overflow-y-auto text-center transform bg-gray-900 lg:left-0">
    ...
    <a href="{{ route('distributors.dashboard') }}" class="flex items-center px-4 py-1 mt-3 ml-2 text-white duration-300 rounded-md cursor-pointer {{ request()->routeIs('distributors.dashboard') ? 'bg-green-600' : 'hover:bg-green-600' }}">
    ...
    <a href="{{ route('distributors.orders.index') }}" class="flex items-center px-4 py-1 mt-3 ml-2 text-white duration-300 rounded-md cursor-pointer {{ request()->routeIs('distributors.orders.index') ? 'bg-green-600' : 'hover:bg-green-600' }}">
        <div class="flex items-center">
    ...
    <a href="{{ route('distributors.returns.index') }}" class="flex items-center px-4 py-1 mt-3 ml-2 text-white duration-300 rounded-md cursor-pointer {{ request()->routeIs('distributors.returns.index') ? 'bg-green-600' : 'hover:bg-green-600' }}">
        <div  class="flex items-center">
    ...
    <a href="{{ route('distributors.cancellations.index') }}" class="flex items-center px-4 py-1 mt-2 ml-2 text-white duration-300 rounded-md cursor-pointer {{ request()->routeIs('distributors.cancellations.index') ? 'bg-green-600' : 'hover:bg-green-600' }}">
        <div class="flex items-center">
    ...
    <a href="{{ route('distributors.delivery.index') }}"  class="flex items-center px-4 py-1 mt-2 ml-2 text-white duration-300 rounded-md cursor-pointer {{ request()->routeIs('distributors.delivery.index') || request()->routeIs('distributors.trucks.index') || request()->routeIs('distributors.trucks.show') ? 'bg-green-600' : 'hover:bg-green-600' }}">
        <div class="flex items-center">
    ...
    <a href="{{ route('distributors.inventory.index') }}" class="flex items-center px-4 py-1 mt-2 ml-2 text-white duration-300 rounded-md cursor-pointer {{ request()->routeIs('distributors.inventory.index') ? 'bg-green-600' : 'hover:bg-green-600' }}">
        <div class="flex items-center">
    ...
    <a  href="{{ route('distributors.insights.index') }}" class="flex items-center px-4 py-1 mt-2 ml-2 text-white duration-300 rounded-md cursor-pointer {{ request()->routeIs('distributors.insights.index') ? 'bg-green-600' : 'hover:bg-green-600' }}">
        <div class="flex items-center">
