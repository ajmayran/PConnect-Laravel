    ...
    <div class="container p-4 mx-auto">
        <div class="max-w-3xl mx-auto">
            ...
            <div class="p-6 bg-white rounded-lg shadow">
                <form action="{{ route('distributors.products.update', $product->id) }}" method="POST"
                    enctype="multipart/form-data">
                    @csrf
                    @method('PUT')

                    <div class="mb-6">
                        <label for="product_name" class="block mb-2 text-sm font-medium text-gray-700">Product
                            Name</label>
                    ...
                    <div class="grid grid-cols-2 gap-6 mb-6">
                        ...
                        <div>
                            <label for="stock_quantity" class="block mb-2 text-sm font-medium text-gray-700">Stock
                                Quantity</label>
                    ...
                    <div class="grid grid-cols-2 gap-6 mb-6">
                        <div>
                            <label for="minimum_purchase_qty"
                                class="block mb-2 text-sm font-medium text-gray-700">Minimum Purchase Quantity</label>
