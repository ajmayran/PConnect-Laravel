{{-- filepath: /c:/Users/nunez/Documents/PConnect-Laravel/resources/views/distributors/products/index.blade.php --}}
@extends('layouts.app')
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 text-sm text-gray-500 whitespace-nowrap">
                            ...
                            @elseif ($product->status == 'rejected')
                                ...
                                <br>
                                <span class="text-xs text-gray-500">{{ $product->rejection_reason }}</span>
                            @endif
                        </td>
