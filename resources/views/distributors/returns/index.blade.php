        ...
        <div class="container p-4 mx-auto">
            ...
            <div class="overflow-hidden bg-white rounded-lg shadow-sm">
                ...
                <div id="returnOrders" class="tab-content">
                    <div class="p-4">
                        <h2 class="mb-4 text-sm text-gray-600">Return Orders: {{ $pendingReturns->count() }}</h2>
                ...
                <div id="refundOrders" class="hidden tab-content">
                    <div class="p-4">
                        <h2 class="mb-4 text-sm text-gray-600">Refunded Orders: {{ $completedReturns->count() }}</h2>
                        <table class="w-full divide-y divide-gray-200">
                            <thead class="bg-gray-50">
                                <tr>
                                    <th
            ...
            <svg class="w-12 h-12 text-green-500 animate-spin" xmlns="http://www.w3.org/2000/svg" 
                ...
                fetch(`{{ route('distributors.returns.show', '') }}/${returnId}`)
                    ...
                    <div class="overflow-hidden bg-white rounded-lg shadow">
                        ...
                        <div class="p-4">
                            <p class="mb-2"><strong>Order ID:</strong> ${data.return.order.formatted_order_id}</p>
                            <p class="mb-2"><strong>Customer:</strong> ${data.return.retailer.first_name} ${data.return.retailer.last_name}</p>
                            <p class="mb-4"><strong>Return Reason:</strong> ${data.return.reason}</p>
                        </div>
                    </div>`;
                    ...
                    <div class="overflow-hidden bg-white rounded-lg shadow">
                        <div class="p-4 border-b bg-gray-50">
                            <h3 class="text-lg font-semibold text-gray-800">Items to Return</h3>
                        </div>
                        ...
                        <tr class="hover:bg-gray-50">
                            <td class="px-4 py-3">
                                <div class="flex items-center gap-3">
                                    ${item.product.image ? 
                                        `<img src="{{ asset('storage') }}/${item.product.image}" alt="${item.product.product_name}" class="object-cover w-16 h-16 rounded-lg" />` :
                    ...
                    <div class="overflow-hidden bg-white rounded-lg shadow">
                        ...
                        <div class="p-4">
                            <a href="{{ asset('storage') }}/${data.return.receipt_path}" target="_blank" class="inline-flex items-center px-4 py-2 text-sm font-medium text-white bg-blue-600 border border-transparent rounded-md shadow-sm hover:bg-blue-700">
