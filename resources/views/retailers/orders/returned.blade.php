<x-app-layout>
    ...
    <div class="container max-w-full px-4 py-8 mx-auto">
        ...
        @if ($orders->isEmpty())
            <div class="flex items-center justify-center p-8 mt-4 bg-white rounded-lg">
                <p class="text-lg text-gray-500">No returned orders found</p>
            </div>
        @else
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @foreach ($orders as $order)
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4">
                                    <span class="inline-flex px-2 py-1 text-xs font-semibold text-indigo-800 bg-indigo-100 rounded-full">
                                        Returned
                                    </span>
                                </td>
        ...
        <div class="relative max-w-4xl p-6 mx-auto mt-10 bg-white rounded-lg shadow-xl">
            ...
            <div id="modalContent" class="mt-4">
                ...
                <div class="flex items-center justify-center p-8">
                    <svg class="w-12 h-12 text-indigo-500 animate-spin" xmlns="http://www.w3.org/2000/svg"
    ...
    <script>
        ...
        function closeOrderModal() {
            ...
            document.getElementById('modalContent').innerHTML =
                '<div class="flex items-center justify-center p-8"><svg class="w-12 h-12 text-indigo-500 animate-spin" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"><circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle><path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path></svg></div>';
        }
