<x-app-layout>
    ...
    <div class="py-8 bg-gray-50">
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="p-6 overflow-hidden bg-white rounded-lg shadow-md sm:p-8"> 
                    ...
                    <form method="GET" action="{{ route('retailers.orders.purchase-history') }}" class="flex items-center gap-3">
                        <div class="relative flex-grow">
                            <input 
                                ...
                                class="w-full px-4 py-2 text-sm border-gray-300 rounded-lg shadow-sm focus:ring-green-500 focus:border-green-500" 
                            />
                        ...
                        <table class="min-w-full divide-y divide-gray-200"> 
                            <thead class="bg-gray-50">
                                <tr>
                                    ...
                                    <th scope="col" class="px-6 py-3 text-xs font-medium tracking-wider text-right text-gray-500 uppercase">Amount</th> 
