        ...
        <div class="flex-1 space-y-6 lg:pl-8">
            ...
            <div class="p-4 bg-white shadow sm:p-8 sm:rounded-lg">
                <header>
                    ...
                    <p class="mt-1 text-sm text-gray-600 dark:text-gray-800">
                        {{ __("Control which types of notifications you'd like to receive.") }}
                    </p>
                </header>

                <div class="mt-6 space-y-4">
                    <!-- Example notification preferences section -->
                    <div class="flex items-center justify-between p-4 border border-gray-200 rounded-md">
                        <div>
                            ...
                            <p class="text-xs text-gray-500">Notifications about your order status changes</p>
                        </div>
                    ...
                    <div class="flex items-center justify-between p-4 border border-gray-200 rounded-md">
                        <div>
                            ...
                            <p class="text-xs text-gray-500">Notifications about payment confirmations and issues</p>
                        </div>
                        <label class="relative inline-flex items-center cursor-pointer">
                            <input type="checkbox" checked class="sr-only peer">
                            <div
                    ...
                    <div class="flex items-center justify-between p-4 border border-gray-200 rounded-md">
                        <div>
                            <h3 class="text-sm font-medium text-gray-900">New Product Announcements</h3>
                            <p class="text-xs text-gray-500">Notifications about new products from your distributors
                            </p>
                        </div>
                        <label class="relative inline-flex items-center cursor-pointer">
                            <input type="checkbox" checked class="sr-only peer">
